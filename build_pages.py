...
photos={"encomendas-expressas":("/assets/pessoas/recepcao.jpg","Registro de uma encomenda na recepção da unidade"),"malotes-e-documentos":("/assets/pessoas/conferencia-digital.jpg","Assinatura digital do recebimento no tablet"),"cargas-fracionadas":("/assets/frota_06.jpg","Frota TAP Express no centro de distribuição")}
