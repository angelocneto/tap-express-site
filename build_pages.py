...
hero='<p class="kicker">Rastreamento</p><h1>Onde está a minha <span>encomenda?</span></h1><p class="sub">Consulte aqui mesmo, sem sair do site. Use a chave da nota fiscal eletrônica (DANFE) ou o CNPJ com a chave de rastreio informada pela TAP.</p>'
body=f'''<section><div class="wrap two-col"><div class="prose">
<form class="track-form2" id="trackForm" autocomplete="off">
  <div class="track-tabs"><button type="button" class="is-on" data-mode="danfe">Chave da NF-e</button><button type="button" data-mode="chave">CNPJ + chave</button><button type="button" data-mode="senha">Remetente, 30 dias</button></div>
  <div data-pane="danfe"><label>Chave de acesso da NF-e (44 números)</label><input name="danfe" inputmode="numeric" maxlength="44" placeholder="Digite ou cole os 44 números da chave" /></div>
  ...
  <div data-pane="senha" hidden><div class="row2"><div><label>CNPJ do remetente</label><input name="cnpj2" inputmode="numeric" maxlength="18" placeholder="00.000.000/0000-00" /></div><div><label>Senha de rastreio</label><input name="senha" type="password" maxlength="58" placeholder="Fornecida pela TAP" autocomplete="off" /></div></div><p class="track-hint" style="margin-top:8px">Lista todas as encomendas enviadas por esse CNPJ nos últimos 30 dias.</p></div>
