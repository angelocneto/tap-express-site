...
<figure class="side-photo"><img src="/assets/pessoas/rotas.jpg" alt="Equipe da TAP Express planejando rotas sobre o mapa, com a frota ao fundo" /><figcaption>Planejamento de rotas no pátio da matriz</figcaption></figure>
</div></section>
...
hero='<p class="kicker gold">TAPIA · Inteligência que move.</p><h1>Conheça a <span class="gold-text">TAPIA.</span></h1><p class="sub">A inteligência da TAP Express que orienta cada conversa: cotação, rastreamento, cobertura por cidade e atendimento humano, sempre com contexto.</p>'
