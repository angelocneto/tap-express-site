...
<body data-theme="{theme}">
  ...
  <footer class="footer"><div class="wrap footer-grid">
    ...
    <div><h5>Navegação</h5><a href="/sobre/">Sobre a empresa</a><a href="/servicos/">Serviços</a><a href="/unidades/">Rede TAP</a><a href="/cidades/">Cidades atendidas</a><a href="/tapia/">TAPIA</a><a href="/carreiras/">Carreiras</a><a href="/contato/">Contato</a><a href="/privacidade/">Privacidade</a><a class="foot-admin" href="/atendimento/" rel="nofollow">Área interna</a></div>
...
<figure class="side-photo"><img src="/assets/pessoas/rotas-inteligentes.jpg" alt="TAPIA e uma operadora diante do planejador inteligente de rotas da TAP" /><figcaption>Planejamento de rotas no pátio da matriz</figcaption></figure>
</div></section>
<section class="section-pad" data-theme="light"><div class="wrap"><p class="kicker">Frota</p><h2>Caminhões baú, utilitários e carretas <span>com rastreamento via satélite.</span></h2><div class="page-photo-strip"><img src="/assets/frota_01-v2.jpg" alt="Caminhão baú TAP Express no pátio" /><img src="/assets/frota_06-v2.jpg" alt="Frota TAP Express alinhada no centro de distribuição" /><img src="/assets/frota_03-v2.jpg" alt="Carretas TAP Express nas docas" /><img src="/assets/frota_12-v2.jpg" alt="Caminhões TAP Express prontos para rota" /></div></div></section>'''
...
photos={"encomendas-expressas":("/assets/pessoas/recepcao-2.jpg","Registro de uma encomenda na recepção da unidade"),"malotes-e-documentos":("/assets/pessoas/conferencia-digital.jpg","Assinatura digital do recebimento no tablet"),"cargas-fracionadas":("/assets/frota_06.jpg","Frota TAP Express no centro de distribuição")}
...
hero='<p class="kicker">Rastreamento</p><h1>Onde está a minha <span>encomenda?</span></h1><p class="sub">Consulte aqui mesmo, sem sair do site. Informe o CNPJ do remetente e a senha de rastreio fornecida pela TAP para ver todas as encomendas dos últimos 30 dias. Também dá para consultar pela chave da nota fiscal.</p>'
body=f'''<section><div class="wrap two-col"><div class="prose">
<form class="track-form2" id="trackForm" autocomplete="off">
  <div class="track-tabs"><button type="button" class="is-on" data-mode="senha">Remetente (CNPJ + senha)</button><button type="button" data-mode="danfe">Chave da NF-e</button><button type="button" data-mode="chave">Encomenda (CNPJ + chave)</button></div>
  <div data-pane="danfe" hidden><label>Chave de acesso da NF-e (44 números)</label><input name="danfe" inputmode="numeric" maxlength="44" placeholder="Digite ou cole os 44 números da chave" /></div>
  <div data-pane="chave" hidden><div class="row2"><div><label>CNPJ do remetente, destinatário ou pagador</label><input name="cnpj" inputmode="numeric" maxlength="18" placeholder="00.000.000/0000-00" /></div><div><label>Chave de rastreio</label><input name="chave" maxlength="58" placeholder="Informada pela TAP na coleta" /></div></div></div>
  <div data-pane="senha"><div class="row2"><div><label>CNPJ do remetente</label><input name="cnpj2" inputmode="numeric" maxlength="18" placeholder="00.000.000/0000-00" autofocus /></div><div><label>Senha</label><input name="senha" type="password" maxlength="58" placeholder="Senha de rastreio fornecida pela TAP" autocomplete="off" /></div></div><p class="track-hint" style="margin-top:8px">Mostra todas as encomendas enviadas por esse CNPJ nos últimos 30 dias, com situação e previsão de entrega.</p></div>
  <input type="text" name="website" tabindex="-1" autocomplete="off" style="position:absolute;left:-9999px" aria-hidden="true" />
  <div class="track-actions"><button class="btn btn-solid" type="submit">Rastrear</button><span class="track-hint">A chave da NF-e está no DANFE que acompanha a mercadoria, logo abaixo do código de barras.</span></div>
</form>
<div id="trackResult" class="track-result" hidden></div>
<h2>Como funciona</h2><ul><li>Cada encomenda recebe um código na coleta e é lida na saída da origem, na chegada ao centro de distribuição e na unidade de destino.</li><li>O veículo é rastreado por satélite durante toda a rota.</li><li>Na entrega, o cliente assina no tablet do motorista e o comprovante digital fica disponível na hora.</li></ul><h2>Perguntas frequentes</h2>{faq_html(faq_r)}</div><figure class="side-photo"><img src="/assets/pessoas/conferencia-digital.jpg" alt="Cliente assinando o recebimento no tablet do motorista" /><figcaption>Comprovante digital assinado na entrega</figcaption></figure></div></section>'''
write('rastreamento',BASE+'/rastreamento/',"Rastreamento de encomendas | TAP Express","Rastreie suas encomendas TAP Express aqui mesmo: CNPJ do remetente e senha mostram todos os envios dos últimos 30 dias; também pela chave da NF-e. Veículos rastreados via satélite e comprovante de entrega digital.",hero,body,[{"@context":"https://schema.org","@type":"WebPage","name":"Rastreamento TAP Express","url":BASE+"/rastreamento/"},bc(("TAP Express",BASE+"/"),("Rastreamento",BASE+"/rastreamento/")),faq_ld(faq_r)],prio="0.8",crumbs=[("TAP Express","/"),("Rastreamento","/rastreamento/")],extra_js=f'<script src="/rastreio.js?v={V}"></script>')

# ---------------- PRIVACIDADE ----------------
hero='<p class="kicker">Privacidade</p><h1>Como a TAP cuida <span>dos seus dados.</span></h1><p class="sub">Esta página explica, em linguagem direta, o que coletamos no site, para que usamos e como você pede a exclusão.</p>'
body=f'''<section><div class="wrap prose" style="max-width:820px"><h2>O que coletamos</h2><ul><li><b>Cotação:</b> nome, telefone ou WhatsApp, e-mail, empresa, CNPJ, cidades de origem e destino e dados da carga. Servem para responder o pedido de frete.</li><li><b>Trabalhe conosco:</b> nome, contato, cidade, CNH, experiência e currículo. Servem para o processo seletivo.</li><li><b>Rastreamento:</b> a chave da nota, o CNPJ e a senha de rastreio são repassados ao portal SSW para consulta e não ficam guardados. Se você pedir atualizações, guardamos nome, WhatsApp e e-mail com a data do aceite.</li></ul><h2>Para que usamos</h2><p>Para atender o pedido que você fez, avisar sobre a entrega quando você pedir e, se autorizado, enviar comunicações da TAP por WhatsApp e e-mail. Não vendemos nem compartilhamos dados com terceiros fora do necessário para a operação, como o sistema de transporte SSW.</p><h2>Seus direitos</h2><p>Você pode pedir a correção, a cópia ou a exclusão dos seus dados e cancelar o recebimento de mensagens a qualquer momento pelo e-mail <a href="mailto:{EMAIL}">{EMAIL}</a> ou pelo WhatsApp <a href="https://wa.me/{WA}" target="_blank" rel="noopener">(18) 99109-6441</a>.</p><h2>Responsável</h2><p>TAP Express Eireli ME, CNPJ 03.053.802/0001-58, Rod. SP 270 Raposo Tavares, km 556, Regente Feijó, SP. Atualizado em {datetime.date.today().strftime("%d/%m/%Y")}.</p></div></section>'''
write('privacidade',BASE+'/privacidade/',"Política de privacidade | TAP Express","O que a TAP Express coleta no site, para que usa e como pedir a exclusão dos seus dados.",hero,body,[{"@context":"https://schema.org","@type":"WebPage","name":"Política de privacidade TAP Express","url":BASE+"/privacidade/"},bc(("TAP Express",BASE+"/"),("Privacidade",BASE+"/privacidade/"))],prio="0.3",crumbs=[("TAP Express","/"),("Privacidade","/privacidade/")])
...
hero='<img class="tapia-logo" src="/assets/tapia-logo-2.png" alt="TAP.IA, inteligência que move" /><h1>Conheça a <span class="gold-text">TAPIA.</span></h1><p class="sub">A inteligência da TAP Express que orienta cada conversa: cotação, rastreamento, cobertura por cidade e atendimento humano, sempre com contexto.</p>'
...
body=f'<section><div class="wrap two-col"><div class="prose"><div class="facts"><div><b><a href="tel:+551839187777" style="color:inherit">(18) 3918-7777</a></b><span>Telefone central · SAC 24h</span></div><div><b><a href="https://wa.me/{WA}?text={WA_TXT}" target="_blank" rel="noopener" style="color:inherit">WhatsApp</a></b><span>(18) 99109-6441</span></div><div><b><a href="mailto:{EMAIL}" style="color:inherit">E-mail</a></b><span>{EMAIL}</span></div></div><h2>Matriz e centro de distribuição</h2><p>Rod. SP 270 Raposo Tavares, km 556, Regente Feijó, região de Presidente Prudente, SP. <a href="https://www.google.com/maps/place/22%C2%B009\'12.5%22S+51%C2%B023\'28.2%22W/@-22.1534593,-51.393727,17z" target="_blank" rel="noopener">Como chegar</a>.</p><h2>Unidades</h2><p>Cada unidade tem telefone próprio. Veja endereços e cidades atendidas em <a href="/unidades/">unidades</a> ou procure sua cidade em <a href="/cidades/">cidades atendidas</a>.</p><h2>Redes</h2><p><a href="https://www.instagram.com/tap.transportes/" target="_blank" rel="noopener">Instagram @tap.transportes</a> · <a href="https://www.facebook.com/taptransportes/" target="_blank" rel="noopener">Facebook</a></p></div><figure class="side-photo"><img src="/assets/pessoas/recepcao-2.jpg" alt="Atendimento na recepção da unidade TAP Express" /><figcaption>Atendimento na unidade</figcaption></figure></div></section>'
...
MAP_BLOCK=_idx[_a:_b].replace('mapwrap reveal','mapwrap').replace('class="reveal"','').replace(' reveal"','"')
MAP_BLOCK=re.sub(r'<a class="map-hud tl map-hud-link"[^>]*>(.*?)</a>', r'<div class="map-hud tl">\1</div>', MAP_BLOCK).replace(' ↗','')
map_section='<section class="section-pad" style="padding-top:0"><div class="wrap"><h2>Mapa da rede</h2><p class="sub" style="margin:8px 0 22px">Toque em uma unidade no mapa para ver a foto, as cidades atendidas e os dias de rota. Ou busque sua cidade.</p></div>'+MAP_BLOCK+'</section>'
body=map_section+''.join(f'<section class="section-pad"><div class="wrap"><h2>{nm}</h2><div class="grid-3" style="margin-top:18px">{unit_tiles(uf)}</div></div></section>' for uf,nm in (("SP","São Paulo"),("PR","Paraná"),("MS","Mato Grosso do Sul")))
MAP_JS=f'<link rel="stylesheet" href="https://unpkg.com/maplibre-gl@4.7.1/dist/maplibre-gl.css" /><link rel="stylesheet" href="/map.css?v={V}" /><script src="https://unpkg.com/maplibre-gl@4.7.1/dist/maplibre-gl.js"></script><script src="/data/estados.js?v={V}"></script><script src="/map.js?v={V}"></script>'
write('unidades',BASE+'/unidades/',"Rede TAP | Unidades TAP Express em SP, PR e MS",f"Endereços, telefones e cidades atendidas das {N_UNITS} unidades e bases da TAP Express em São Paulo, Paraná e Mato Grosso do Sul.",hero,body,[{"@context":"https://schema.org","@type":"CollectionPage","name":"Unidades TAP Express","url":BASE+"/unidades/"},bc(("TAP Express",BASE+"/"),("Unidades",BASE+"/unidades/"))],prio="0.9",crumbs=[("TAP Express","/"),("Rede TAP","/unidades/")],extra_js=MAP_JS)
