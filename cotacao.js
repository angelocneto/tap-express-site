...
(function () {
  ...
  chatBody.addEventListener("click", (e) => {
    ...
    if (a === "rastrear") { say(t("Quero rastrear uma encomenda."), true); say(t("Você rastreia aqui no site, com a chave da nota fiscal ou o CNPJ e a chave de rastreio. Abrindo a página…")); setTimeout(() => { toggleChat(false); location.href = L("/rastreamento/"); }, 900); return; }
  ...
  chatForm.addEventListener("submit", (e) => {
    ...
    if (/rastre|onde esta|cadê|cade|encomenda|nota|track|where is|parcel|package|shipment|seguimiento|paquete|dónde|donde|追踪|查询|包裹|货物/.test(n)) { say(t("Para rastrear, use o portal oficial da TAP. Abrindo em nova aba…")); setTimeout(() => { location.href = L("/rastreamento/"); }, 800); return; }
