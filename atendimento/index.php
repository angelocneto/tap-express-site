...
$cards = [
    ...
    ['atendimento', 'leads.php', 'Leads', 'Pessoas que deixaram nome, WhatsApp e e-mail no site para receber atualizações. Base para as próximas ações comerciais.', $cnt("SELECT COUNT(*) FROM leads WHERE status='novo'") . ' novos', '<svg viewBox="0 0 24 24" width="22" height="22" fill="none" stroke="currentColor" stroke-width="1.8"><path d="M4 4h16v11H8l-4 4z"/><path d="M8 8h8M8 11h5"/></svg>'],
